...
document.write(10 > 2); //The output would be true because 10 is more than 2.//

document.write(10 < 2); //The output would be false because 2 is less than 10.//
...
function not_Function() { //This checks whether comething is false or not, in this case it is true because the variable is false//
